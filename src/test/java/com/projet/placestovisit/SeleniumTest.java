...
public class SeleniumTest {
	...
	private static String accueilUrl;
	...
	public void setUp() throws Exception {
		...
		accueilUrl = "https://secure-crag-94496.herokuapp.com/";
		driver.get(accueilUrl);
		Thread.sleep(2000);
	}
	...
	public static void SeleniumListUpdateTest() throws InterruptedException {
		...
		// Décider d'y aller dans les 7 jourq
		List<WebElement> formDate = driver.findElements(By.xpath("//select[@id='priority']//option"));
